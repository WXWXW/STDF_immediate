...
import com.stdf.util.ByteArray;
import com.stdf.v4.Types;
...
/**
 * STDFReader
 * Based on pystdf <http://zx/.google.com/p/pystdf/>
...
public class STDFReader{
   ...
   public STDFReader(InputStream stream) throws IOException{
      ...
      if(header == 0x1F8B /*判断STDF文件是否是GZIP压缩格式*/)
   ...
   public void parse(RecordVisitor visitor) throws FileNotFoundException,
      ...
      parse(visitor, Types.getRecordDescriptors());
   }
